...
export const useActivities = (id?: string) => {
    ...
    const { data: activities, isLoading } = useQuery({
        ...
        enabled: !id && location.pathname === '/activities' && !!currentUser  // This query will be enabled when we call it explicitly
    });
    ...
    = useQuery({
            ...
            enabled: !!id  && !!currentUser // This query will be enabled when we call it explicitly
        });
